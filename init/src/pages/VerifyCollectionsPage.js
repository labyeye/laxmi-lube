...
const VerifyCollectionsPage = () => {
  ...
  const [lastFiveDigits, setLastFiveDigits] = useState(""); // shared per open modal
  ...
  // Verifies all pending bills in the current group using last-5-digit matching
  const handleVerifyAll = async () => {
    ...
    // Cash doesn't need digits — always verified
