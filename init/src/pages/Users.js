...
const TabRow = styled.div`
  ...
  border-radius: var(--nb-radius); border: 1px solid var(--nb-border);
`;
...
const BulkBar = styled.div`
  ...
  background: var(--nb-cream); border: 1px solid var(--nb-border); border-radius: var(--nb-radius-sm); margin-bottom: 0.75rem;
...
const DataTable = styled.table`
  ...
  th {
    ...
    padding: 0.75rem 1rem; border-bottom: 1px solid var(--nb-border); text-align: left;
...
const RoleBadge = styled.span`
  ...
  font-size: 0.72rem; font-weight: 700; text-transform: capitalize; border: 1px solid var(--nb-border);
...
const IconBtn = styled.button`
  width: 30px; height: 30px; border: 1px solid var(--nb-border); border-radius: var(--nb-radius-sm);
...
const StatusPill = styled.span`
  ...
  padding: 0.2rem 0.6rem; border-radius: 999px; font-size: 0.72rem; font-weight: 700; border: 1px solid var(--nb-border);
...
const PagBtn = styled.button`
  padding: 0.35rem 0.7rem; border: 1px solid var(--nb-border); border-radius: var(--nb-radius-sm);
  background: ${(p) => (p.active ? "var(--nb-blue)" : "var(--nb-white)")};
  color: ${(p) => (p.active ? "var(--nb-white)" : "var(--nb-ink)")};
...
const SectionTitle = styled.h3`
  ...
  padding-bottom: 0.5rem; border-bottom: 1px solid var(--nb-border);
`;
...
const ToggleSwitch = styled.button`
  width: 42px; height: 22px; border-radius: 999px; border: 1px solid var(--nb-border);
...
const SettingSelect = styled.select`
  padding: 0.35rem 0.6rem; border: 1px solid var(--nb-border); border-radius: var(--nb-radius-sm);
  background: var(--nb-white); color: var(--nb-ink); font-size: 0.85rem; cursor: pointer;
  &:focus { outline: none; border-color: var(--nb-blue); }
`;
...
const ModalBox = styled.div`
  position: relative; background: var(--nb-white); border: 1px solid var(--nb-border);
...
const ModalHead = styled.div`
  ...
  background: var(--nb-muted); border-bottom: 1px solid var(--nb-border);
...
const FieldInput = styled.input`
  padding: 0.6rem 0.75rem; border: 1px solid var(--nb-border); border-radius: var(--nb-radius-sm);
