    ...
    <ModuleProvider>
      <Router>
        ...
        <Route
          ...
          element={
            user?.role === "admin" ? <Navigate to="/admin/view-retailer" replace /> : <Navigate to="/login" />
          }
        />
        ...
        <Route
          ...
          element={
            user?.role === "admin" ? <Navigate to="/admin/view-product" replace /> : <Navigate to="/login" />
          }
        />
        {/* View Retailer */}
        <Route
        ...
        <Route
          ...
          element={
            user?.role === "admin" ? <Navigate to="/admin/bills" replace /> : <Navigate to="/login" />
          }
        />
